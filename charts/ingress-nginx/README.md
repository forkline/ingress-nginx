...
![Version: 2026.8.21](https://img.shields.io/badge/Version-2026.8.21-informational?style=flat-square) ![AppVersion: 2026.8.21](https://img.shields.io/badge/AppVersion-2026.8.21-informational?style=flat-square)
...
This chart uses date-based versioning (e.g. `2026.8.21`). The chart version matches the release tag.
...
| controller.admissionWebhooks.patch.image.tag | string | `"2026.8.21"` |  |
...
| controller.image.tag | string | `"2026.8.21"` |  |
...
| defaultBackend.image.tag | string | `"2026.8.21"` |  |
