...
![Version: 2026.9.3](https://img.shields.io/badge/Version-2026.9.3-informational?style=flat-square) ![AppVersion: 2026.9.3](https://img.shields.io/badge/AppVersion-2026.9.3-informational?style=flat-square)
...
| controller.admissionWebhooks.patch.image.tag | string | `"2026.9.3"` |  |
...
| controller.image.tag | string | `"2026.9.3"` |  |
...
| defaultBackend.image.tag | string | `"2026.9.3"` |  |
