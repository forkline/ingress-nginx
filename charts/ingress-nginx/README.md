...
![Version: 2026.6.18](https://img.shields.io/badge/Version-2026.6.18-informational?style=flat-square) ![AppVersion: 2026.6.18](https://img.shields.io/badge/AppVersion-2026.6.18-informational?style=flat-square)
...
| controller.admissionWebhooks.patch.image.tag | string | `"2026.6.18"` |  |
...
| controller.image.tag | string | `"2026.6.18"` |  |
...
| defaultBackend.image.tag | string | `"2026.6.18"` |  |
