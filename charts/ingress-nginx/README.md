...
![Version: 2026.5.24](https://img.shields.io/badge/Version-2026.5.24-informational?style=flat-square) ![AppVersion: 2026.5.24](https://img.shields.io/badge/AppVersion-2026.5.24-informational?style=flat-square)
...
| controller.admissionWebhooks.patch.image.tag | string | `"2026.5.24"` |  |
...
| controller.image.tag | string | `"2026.5.24"` |  |
...
| defaultBackend.image.tag | string | `"2026.5.24"` |  |
