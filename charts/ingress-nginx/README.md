...
![Version: 2026.6.28](https://img.shields.io/badge/Version-2026.6.28-informational?style=flat-square) ![AppVersion: 2026.6.28](https://img.shields.io/badge/AppVersion-2026.6.28-informational?style=flat-square)
...
| controller.admissionWebhooks.patch.image.tag | string | `"2026.6.28"` |  |
...
| controller.image.tag | string | `"2026.6.28"` |  |
...
| defaultBackend.image.tag | string | `"2026.6.28"` |  |
